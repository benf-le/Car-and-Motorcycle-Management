...
public class Oto extends JFrame {
    ...
    public void Button()
    {
        ...
        btDky.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String sql = "INSERT INTO dbo.Oto" +
        ...
        btSua.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    Connection conn = Connect.getConnection();
                    String sql = "UPDATE dbo.Oto SET TenChuXe = ? ,NhanHieu = ? ,SoLoai = ? ,MauSon = ? ,SoMay = ?" +
                            " ,SoKhung = ? ,BienSo = ? ,DungTich = ? ,NgayDangKy = ?  WHERE MaDinhDanh = ? " ;
                    PreparedStatement prm = conn.prepareStatement(sql);

                    prm.setString(1,tfTen.getText());
                    prm.setString(2,tfMauSon.getText());
                    prm.setString(3,tfSoMay.getText());
                    prm.setString(4,tfSoKhung.getText());
                    prm.setString(5,tfSoLoai.getText());
                    prm.setString(6,tfNhanHieu.getText());
        ...
        btXoa.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    Connection conn = Connect.getConnection();
                    String sql = "DELETE FROM Oto  WHERE MaDinhDanh = ? " ;
                    PreparedStatement prm = conn.prepareStatement(sql);
    ...
    public void Bottom()
    {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM dbo.Oto" +
    ...
    public void updateTable(){
        try {
            ...
            Statement st ;
            String sqlf="\n" +
                    "SELECT MaDinhDanh,TenChuXe,MauSon,SoMay,SoKhung,NhanHieu,SoLoai,BienSo,DungTich,NgayDangKy   FROM Oto";
            ResultSet rs ;
